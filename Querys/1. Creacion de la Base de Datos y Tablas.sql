...
del numero. Creamos una relación con la tabla avión en la que el vuelo tendrá el id del avion que realiza ese vuelo*/
create table vuelo(
...
create table reserva(
	...
	constraint chk_fp check (tipo_documento in ('efectivo','tarjeta de credito', 'transferencia bancaria'))
);
